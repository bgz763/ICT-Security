...
8. Click the right mouse to see all the login functions, of which my favorite is the feature with which the program automatically enters the username and password on the previous open page  ![image](https://github.com/bgz763/ICT-Security/assets/149093937/f7e5f800-b7a2-46b6-b94d-cf51431c4136)
